// src/app/dashboard/masjid-admin/manage/modules/masjids/PrayerRulesForm.js
...
export default function PrayerRulesForm({ value = {}, onChange }) {
  ...
  return (
    <div className="border rounded-xl p-4 space-y-4 bg-slate-50">
      <h3 className="font-semibold text-slate-700">Prayer Timings</h3>
